...
comment_reply_attachment_missing_content_type = Missing Content-Type for image upload
...
communities_filter_local = local
communities_filter_remote = remote
communities_filter_mine = mine
...
community_delete_title = Delete Community
...
modlog_site = Site Modlog
must_login = You must log in to do that
my_invitations = My Invitations
name_prompt = Name:
new_notifications = New Notifications
new_post_poll = Add Poll
no_cancel = No, cancel
...
post_site_block_title = Block Post from Site
post_site_block_question = Block this post from the site?
post_site_block_question_description = This will remove the local copy of this post and prevent it from being refetched.
...
site_block = block from site
site_block_yes = Yes, block
sort = Sort:
sort_hot = hot
sort_new = new
sort_top = top
